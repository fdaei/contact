...
use common\models\LegalContactFile;
use common\models\LegalContacttSearch;
...
/**
 * LegalContactController implements the CRUD actions for LegalContact model.
 */
class LegalContactController extends Controller
{
    ...
    /**
     * Lists all LegalContact models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new LegalContacttSearch();
    ...
    /**
     * Displays a single LegalContact model.
     * @param int $id شناسه
     * @return string
    ...
    /**
     * Creates a new LegalContact model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new LegalContact();
        ...
        $uploadFiles = [new LegalContactFile];
        $searchedTags = Tag::find()->andWhere(['in', 'tag_id', $model->tagNames])->asArray()->all();
        $tagSelected = [];

        if ($model->load(Yii::$app->request->post())) {
            $model->contact_tag = Yii::$app->request->post('LegalContact')['contact_tag'];
            $tagSelected = Yii::$app->request->post('LegalContact')['contact_tag'];
            ...
            var_dump("sksksk");die();
            $uploadFiles = Model::createMultiple(LegalContactFile::classname());
        ...
        return $this->render('create', [
            ...
            'uploadFile' => (empty($uploadFile)) ? [new LegalContactFile] : $uploadFile,
    ...
    /**
     * Updates an existing LegalContact model.
    ...
    /**
     * Deletes an existing LegalContact model.
    ...
    /**
     * Finds the LegalContact model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id شناسه
     * @return LegalContact the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LegalContact::findOne(['id' => $id])) !== null) {
            return $model;
        }
